...
## 6) Seeding Script Update

- Ensure prisma/seed.ts uses the same **adapter** and **dotenv** import as runtime:
...
5. If **P1017 / connection** errors: 
   - Confirm DATABASE_URL and network reachability. 
   - Confirm import 'dotenv/config' executes early. 
6. If **module resolution** errors: 
   - Confirm "type": "module", ESM imports, and re-generate client.
